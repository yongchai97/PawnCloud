...
public abstract class PawnCloudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PawnCloudWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PawnCloudWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PawnCloudDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PawnCloudDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PawnCloudDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PawnCloudDbContext, Task<T>> func)
    {
        T result;
