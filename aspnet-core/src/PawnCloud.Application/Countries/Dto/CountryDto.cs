...
namespace PawnCloud.Countries.Dto
{
    public class CountryDto : EntityDto<int?>
    {
        ...
        public CountryDto() { }
        public CountryDto(int? id, string countryName, string countryCodeTwoAlphabet, string countryCodeThreeAlphabet, string sequenceNumber, string riskLevel, bool help, int effectiveYear)
        {
            this.Id = id;
