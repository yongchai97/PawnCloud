...
namespace PawnCloud.Migrations
{
    ...
    [Migration("20260905125451_pawn ticket payments")]
    partial class pawnticketpayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PawnCloud.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawnCloud.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PawnCloud.BasicCodes.BasicCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MiscMasterConfig")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("systemProvidedValue")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.HasIndex("MiscMasterConfig");

                    b.ToTable("BasicCodes");
                });

            modelBuilder.Entity("PawnCloud.Countries.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("countryCodeThreeAlphabet")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("countryCodeTwoAlphabet")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PawnCloud.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawnCloud.DailyGoldPrices.DailyGoldPrice", b =>
                {
                    ...
                    b.ToTable("DailyGoldPrices");
                });

            modelBuilder.Entity("PawnCloud.GeneralSetups.GeneralSetup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("AppendYearMonth")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("appendedString")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("appendedStringBackMethod")
                        .HasColumnType("int");

                    b.Property<decimal>("maximumAllowedPercentage")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PawnCloud.ItemListings.ItemListing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawnCloud.ItemStatuses.ItemStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawnCloud.MiscMasterConfigs.MiscMasterConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MiscMasterConfigs");
                });

            modelBuilder.Entity("PawnCloud.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawnCloud.PawnItems.PawnItem", b =>
                {
                    ...
                    b.Property<decimal>("includedItemValue")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("pawnItemNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PawnCloud.PawnTicketPayments.PawnTicketPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawnCloud.PawnTickets.PawnTicket", b =>
                {
                    ...
                    b.Property<decimal>("monthlyCustody")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PawnCloud.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PawnCloud.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PawnCloud.Authorization.Roles.Role", b =>
                {
                    b.HasOne("PawnCloud.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("PawnCloud.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("PawnCloud.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PawnCloud.BasicCodes.BasicCode", b =>
                {
                    b.HasOne("PawnCloud.MiscMasterConfigs.MiscMasterConfig", "MiscMasterConfigFk")
                        .WithMany()
