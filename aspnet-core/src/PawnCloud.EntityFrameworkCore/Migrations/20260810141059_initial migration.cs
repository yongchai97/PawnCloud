        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    oldIC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    BusinessNature = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    availableForUser = table.Column<bool>(type: "bit", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MiscMasterConfigs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoldType = table.Column<int>(type: "int", nullable: false),
                    memberPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    nonMemberPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyGoldPrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyGoldPrices_GoldTypes_GoldType",
                        column: x => x.GoldType,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    systemProvidedValue = table.Column<bool>(type: "bit", nullable: false),
                    MiscMasterConfig = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasicCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasicCodes_MiscMasterConfigs_MiscMasterConfig",
                        column: x => x.MiscMasterConfig,
                        principalTable: "MiscMasterConfigs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasicCodes_MiscMasterConfig",
                table: "BasicCodes",
                column: "MiscMasterConfig");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyGoldPrices_GoldType",
